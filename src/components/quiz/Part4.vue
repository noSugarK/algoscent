<!-- src/components/quiz/PartImageMultiple.vue -->
<template>
  <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
    ...
    >
      <div class="relative">
        ...
        <div v-if="multiAnswer.includes(option.value)" class="absolute top-2 right-2 w-6 h-6 bg-indigo-500 rounded-full flex items-center justify-center">
    ...
    <div v-if="multiAnswer.length > (question.maxSelection || 3)" class="col-span-full text-center mt-2 text-red-500 text-sm">
